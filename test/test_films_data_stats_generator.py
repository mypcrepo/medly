...
from films.films_api_service import FilmsAPIService
...
def test_director_with_most_films(stats_generator_setup):
    assert stats_generator_setup.get_director_with_most_films() == RIDLEY_SCOTT_DIRECTOR
